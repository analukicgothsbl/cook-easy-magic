-- Atomically replace a daily meal plan and charge credits for authenticated users.
-- This prevents partial success states where recipes/meal_plan are saved but charging fails.
...
REVOKE ALL ON FUNCTION public.create_meal_plan_and_charge(
  UUID,
  DATE,
  JSONB,
  NUMERIC
...
GRANT EXECUTE ON FUNCTION public.create_meal_plan_and_charge(
  UUID,
  DATE,
  JSONB,
  NUMERIC
